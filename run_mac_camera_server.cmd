...
echo python3 app/camera_uploader.py --source 0 --server-url http://WINDOWS_PC_IP:8000 --show-local-preview --stt --stt-phrase-seconds 2.5 --stt-silence-seconds 0.5 --select-audio-device
echo.
