...
echo [launcher] MacBook should send camera frames to http://WINDOWS_PC_IP:8001
...
echo python3 app/camera_uploader.py --source iphone --server-url http://WINDOWS_PC_IP:8001 --max-fps 24 --frame-width 1120 --jpeg-quality 72 --stt --stt-phrase-seconds 2.0 --stt-silence-seconds 0.45 --stt-speech-level 0.004 --stt-min-peak-level 0.020 --stt-gain 3.0 --stt-auto-gain-target 0.08 --select-audio-device
